      ...
      <section id="instructors" className="py-32 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6 text-center">
           ...
           <div className="grid md:grid-cols-3 gap-12">
              <InstructorCard name="Sensei Ryu Tanaka" role="7th Dan Master" desc="Head instructor with specialized expertise in Shito-ryu Katas." img="https://res.cloudinary.com/djcbxippx/image/upload/f_auto,q_auto/Gemini_Generated_Image_f3h0omf3h0omf3h0_vivm5z=80&w=1974&auto=format&fit=crop" />
