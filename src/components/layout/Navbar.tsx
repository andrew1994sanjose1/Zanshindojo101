  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white shadow-sm border-b border-slate-100 h-20 flex items-center px-6 md:px-12 justify-between">
      ...
      <div className="hidden md:flex items-center gap-8 text-sm font-semibold text-slate-500 uppercase tracking-widest">
        <a href="#home" className="text-black hover:text-rose-600 transition-colors">Home</Link>
        ...
        {user ? (
          ...
          <button onClick={signIn}
            disabled={true}
            className="px-6 py-2.5 bg-slate-900 text-white rounded-full text-sm font-bold hover:bg-slate-800 transition-colors shadow-lg shadow-slate-200 cursor-pointer">
            Sign In
          </button>
        )}
      </div>
